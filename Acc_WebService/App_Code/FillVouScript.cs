...
public class FillVouScript
{
    ...
    //public string 傳票號1 { get; set; }
    //public string 傳票明細號1 { get; set; }
    //public string 製票日期1 { get; set; }
    //public string 傳票號2 { get; set; }
    //public string 傳票明細號2 { get; set; }
    //public string 製票日期2 { get; set; }
}